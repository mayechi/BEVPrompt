...
class AV2Dataset(Dataset):
    ...
    def format_results(self, outputs):
        ...
        pd.DataFrame.to_csv(predictionsDataFrame, "results/val_detections_0.1_150.csv")
    ...
    def evaluate(self, results, out_path=None, **kwargs):
        ...
        # predictions = "./results/val_detections_0.1.csv"
        # ground_truth = "./results/val_gt_0.1.csv"
        if predictions is not None:
            ...
            if out_path is not None:
                pd.DataFrame.to_csv(groundTruthDataFrame, out_path + "/{}_gt_0.1.csv".format(split))
                pd.DataFrame.to_csv(predictionsDataFrame, out_path + "/{}_detections_0.1.csv".format(split))
        ...
        for min_range, max_range in range_list:
            ...
            # cfg.categories = ["REGULAR_VEHICLE"]
        ...
        json_path = './results/metrics_av2.json'
        json.dump(metrics.to_json(), open(json_path, 'w'))
