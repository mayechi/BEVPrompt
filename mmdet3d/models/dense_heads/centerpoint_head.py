...
class CenterHead(BaseModule):
    ...
    def forward_single(self, x, mats_dict=None):
    ...
    def forward(self, feats, mats_dict=None):
        """Forward pass.
        ...
        """
        return multi_apply(self.forward_single, feats, [mats_dict])
    ...
    def get_bboxes(self, preds_dicts, img_metas, img=None, rescale=False):
        ...
        for i in range(num_samples):
            ...
            # Sort by the scores in the multi heads
