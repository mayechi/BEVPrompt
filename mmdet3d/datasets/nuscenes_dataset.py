...
class NuScenesDataset(Dataset):
    ...
    # CLASSES_COARSE = ['car', 'truck', 'trailer', 'bus', 'construction_vehicle', 'bicycle', 'motorcycle', 'emergency_vehicle',
    #            'adult', 'child', 'police_officer', 'construction_worker', 'stroller', 'personal_mobility', 
    #            'pushable_pullable', 'debris', 'traffic_cone', 'barrier']   
    # CLASSES_COARSE = ["vehicle", "pedestrian", "movable"]
    def __init__(self,
                 ann_file,
                 pipeline=None,
                 data_root=None,
        ...
        self.CLASSES_FINEGRAIN = self.get_classes(classes)
        self.file_client = mmcv.FileClient(**file_client_args)
        self.cat2id_finegrain = {name: i for i, name in enumerate(self.CLASSES_FINEGRAIN)}

        from nuscenes.eval.detection.config import config_factory
        self.eval_detection_configs = config_factory(self.eval_version)
        # del self.eval_detection_configs.class_names['vehicle']
        # del self.eval_detection_configs.class_names['pedestrian']
        # del self.eval_detection_configs.class_names['movable']
    ...
    def get_cat_ids(self, idx):
        ...
        for name in gt_names:
            if name in self.CLASSES_FINEGRAIN:
                cat_ids.append(self.cat2id_finegrain[name])
        return cat_ids
    ...
    def get_ann_info(self, index):
        ...
        for cat in gt_names_3d:
            if cat in self.CLASSES_FINEGRAIN:
                gt_labels_3d.append(self.CLASSES_FINEGRAIN.index(cat))
            else:
    ...
    def multimodal_filter(self, predictions, rgb_pre):
        ...
        for sample_token in tokens:
            ...
            filter_lidar = []
            for name in self.CLASSES_FINEGRAIN:
    ...
    def _format_bbox(self, results, jsonfile_prefix=None, filter=None):
        ...
        """
        nusc_annos = {}
        # mapped_class_names = self.CLASSES_COARSE
        ...
        # result_files = './results/pts_bbox/results_nusc_fine_grained.json'
        # with open(result_files) as f:
        #     nusc_submissions = json.load(f) 
    ...
    def evaluate(self, results, out_path=None, **kwargs):
        ...
        # result_files = dict()
        # result_files['pts_bbox'] = './results/pts_bbox/results_nusc_bevformer.json'
    ...
    def _build_default_pipeline(self):
        ...
        pipeline = [
            ...
            dict(
                ...
                class_names=self.CLASSES_FINEGRAIN,
                with_label=False),
...
def lidar_nusc_box_to_global(info,
    ...
    for box in boxes:
        ...
        # For coarse classes dist
        coarse_dict = {"vehicle": 50, "pedestrian": 40, "movable": 30}
        cls_range_map.update(coarse_dict)
